    ...
    return (
        <>
            ...
            >
                ...
                />
                <div
                    className="h-full w-full flex flex-col xl:flex-row items-end justify-end pb-4 pl-4 xl:p-0 gradient-border gradient-border-bottom ">
                    ...
                    >
                        <div
                            className="hover-shine hover:scale-[102%] flex bg-[#F7F0E5] w-full xl:w-[250px] h-[80px] border-r-[16px] border-solid border-[#C1A068] shadow-xl rounded-l-[20px] justify-center items-center px-6 cursor-pointer xl:mb-32 gap-4">
